...
int main() {
    ...
    int pizzaSlices = 12;
    double pi = 3.14159f;
    long int starsInTheUniverse = 1234567890LL;
    char aLetter = 'k';
    std::string aWord {"kaleidescope"};
    long double veryPrecisePi = 3.14159265358979;
    ...
    unsigned short bytes = 65535; 
    unsigned int pizzaslices_pos = 12;
    ...
    std::array<int, 4> mystdarray {5,6,7,8};

    // この配列には大きな数値を格納するので、`int` 型は適していません。どのデータ型が適切ですか。
    long int bigNumbers[] = {500000, 700000, 800000};
    ...
    // ここに定数変数2を記述
    // ここに定数変数3を記述
    const int numofmonth = 12;
    const double pilowaccuracy = 3.14;
    const bool GO = true;
